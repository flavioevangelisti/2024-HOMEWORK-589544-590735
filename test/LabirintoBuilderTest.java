...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		Labirinto bilocale = labirintoBuilder
				...
				.addAdiacenza(nomeStanzaVincente, nomeStanzaIniziale,  Direzione.valueOf("sud"))
				.getLabirinto();
		assertEquals(bilocale.getStanzaVincente(),bilocale.getStanzaCorrente().getStanzaAdiacente(Direzione.valueOf("nord")));
		assertEquals("[nord]",bilocale.getStanzaCorrente().getDirezioni().toString());
	...
	public void testTrilocale(){
		Labirinto trilocale = labirintoBuilder
				...
				.addAdiacenza(nomeStanzaIniziale, "biblioteca", Direzione.valueOf("sud"))
				...
				.addAdiacenza(nomeStanzaVincente,"biblioteca" , Direzione.valueOf("ovest"))
				.getLabirinto();	
		...
		assertEquals("biblioteca",trilocale.getStanzaCorrente().getStanzaAdiacente(Direzione.valueOf("sud")).getNome());
	}
	...
	public void testTrilocaleConStanzaDuplicata() {
				...
				.addStanza("stanza generica")
				.addAdiacenza(nomeStanzaIniziale, "stanza generica", Direzione.valueOf("nord"))
				.getLabirinto();
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getStanze().get(nomeStanza).getAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		List<Attrezzo> attrezzi = labirintoBuilder.getStanze().get(nomeStanza).getAttrezzi();
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente,labirintoBuilder.getStanze().get("stanza bloccata").getStanzaAdiacente(Direzione.nord));	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata,labirintoBuilder.getStanze().get("stanza bloccata").getStanzaAdiacente(Direzione.nord));
	}
